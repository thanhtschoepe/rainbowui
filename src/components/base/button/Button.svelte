...
<button
	...
	on:keypress
	{...$$restProps}
	class={'backlight hover:shadow-lg outline-none relative inline-flex gap-2 items-center rounded-xs typo-body2 text-dark dark:text-light disabled:opacity-50 disabled:pointer-events-none ' +
		$$restProps.class}
